...
const PrivacyPolicy = () => (
  <Layout>
    <h1>Privacy Policy of MyTrail</h1>
    <p>MyTrail operates the www.mytrail.live website, which provides the SERVICE.</p>
    <p>
      This page is used to inform website visitors regarding our policies with the collection, use,
      and disclosure of Personal Information if anyone decided to use our Service, the MyTrail
      website.
    </p>
    <p>
    ...
    <p>
      ...
      which is accessible at www.mytrail.live, unless otherwise defined in this Privacy Policy.
    </p>
    ...
    <p>
      ...
      us at <a href="mailto:support@mytrail.live">support@mytrail.live</a>
    </p>
  </Layout>
);
