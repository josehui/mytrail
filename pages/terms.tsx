...
const PrivacyPolicy = () => (
  <Layout>
    <Container size="xl">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to MyTrail.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to MyTrail, accessible from{' '}
            <a href="mytrail.live" rel="external nofollow noopener" target="_blank">
              mytrail.live
            </a>
          </p>
        </li>
      ...
      <ul>
        <li>By email: support@mytrail.live</li>
      </ul>{' '}
    </Container>
  </Layout>
);
